...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Repository contains a pre-commit hook (or equivalent script) checking for laravel/sail references.
- [x] #2 Instructions cover enabling the hook.
- [x] #3 Hook behaves safely when triggered (non-zero exit with helpful message).
<!-- AC:END -->
